...
CREATE TABLE `itens_compra` (
  ...
  KEY `fk_venda_idx` (`fk_venda`),
  KEY `fk_produto_idx` (`fk_produto`),
  CONSTRAINT `fk_produto1` FOREIGN KEY (`fk_produto`) REFERENCES `catalogo` (`codigo`),
  CONSTRAINT `fk_venda1` FOREIGN KEY (`fk_venda`) REFERENCES `compra` (`codigo`)
...
-- Dump completed on 2019-07-03 21:09:00
